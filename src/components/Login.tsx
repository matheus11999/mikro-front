          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            {isSignUp && (
              <div className="form-group">
                ...
                <select value={role} onChange={e => setRole(e.target.value as 'admin' | 'user')} className="input-field">
            ...
            <button
              type="button"
              className="w-full mt-2 btn-secondary h-11 text-base font-semibold"
